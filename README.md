  # Note: 
This project was a group work, and I was responsible for both the hardware and software parts. For the hardware, I handled the overall operation of the system, including components and circuits. On the software side, I integrated the system with sensors and an IoT platform using Blynk.
  
  # Documentation during the process and the final result          
